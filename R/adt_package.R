...
#'     
#' @param par_apoe A list mapping apoe labels to different levels. The default setting
#'     is \code{list(levels = c(3.4, 4.4, 2.4),labels = c(1, 2, NA))}.
#'
#' @param verbose A logical value indicating weather printing out process information.
#'
